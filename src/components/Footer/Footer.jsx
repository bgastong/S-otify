      ...
      <div className={styles.grid}>
        ...
        <div className={`${styles.section} ${styles.brandSection}`}>
          ...
          <p className={styles.brandTagline}>
            {t('footer.brandTagline')} <br />
            <span className="text-zinc-600">{t('footer.madeWithLove')}</span>
          </p>
        </div>
        ...
        {/* Contact Section */}
        <div className={styles.section}>
          <h4 className={styles.sectionTitle}>{t('footer.connectTitle')}</h4>
          <a href="https://github.com/bgastong/S-otify" className={styles.contactEmail} target="_blank" rel="noopener noreferrer">
            {t('footer.viewOnGitHub')}
          </a>
          <div className={styles.socialIcons}>
            <a href="https://github.com/bgastong/S-otify" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label={t('footer.github')}>
              <GitHubIcon />
            </a>
            <span className={styles.socialIcon} title={t('footer.spotifyInspired')}>
              <SpotifyIcon />
            </span>
          </div>
        </div>
