...
- image: string
- youtubeId: string
- audioUrl: string (opcional, URL directa de audio/mp3)
- album: string
...
- Si una cancion trae audioUrl, el reproductor usa audio nativo (prioridad alta).
- Si no hay audioUrl, se usa youtubeId como fallback.
- Si el embed de YouTube falla, la app informa el error y ofrece alternativa externa.
